...
# download and install postgresql 8.3
...
rm -rf "$HOME/database/83"

rm -rf postgresql-8.3.23
tar xzf postgresql-8.3.23.tar.gz

cd postgresql-8.3.23
./configure --prefix="$HOME/database/83" CFLAGS="-O1" CC=clang
make
make install
